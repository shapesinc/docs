...
- **Make a few.** A chill one for friends, a focused one for a [work chat](/ai-at-work), then set per-chat overrides.
...
<CardGroup cols={2}>
  ...
  <Card title="Designing social intelligence" icon="user-group" href="/designing-social-intelligence">
