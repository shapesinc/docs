...
<CardGroup cols={2}>
  ...
  <Card title="The right length" icon="ruler">
    It matches the chat. Two lines in a fast group chat; a paragraph when the scene calls for it.
  </Card>
...
<Steps>
  ...
  <Step title="A great Shape that belongs in the chat">
...
flowchart TD
    ...
    G --> H(("A Shape people<br/>want in the chat"))
```
...
The single biggest lever for group chats is **reply length**. A Shape that writes essays will bury a fast-moving chat. Spell out the shape of a reply:
