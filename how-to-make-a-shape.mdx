...
Making your own AI on Shapes takes a few minutes. You give it a name and a personality, pick a model to run it on, and it's ready to talk. Then you can drop it into a [group chat](/ai-group-chats) with your friends.
